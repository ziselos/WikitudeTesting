 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_plugins_SimpleInputPluginActivity_setImageSensorRotation(JNIEnv* env, jobject obj, jint rotation) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_plugins_SimpleInputPluginActivity_setCameraFieldOfView(JNIEnv* env, jobject obj, jfloat fieldOfView) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_plugins_SimpleInputPluginActivity_setFrameSize(JNIEnv* env, jobject obj, jint frameWidth, jint frameHeight) {
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_plugins_SimpleInputPluginActivity_notifyNewCameraFrame(
 ...
 */
extern "C" JNIEXPORT void JNICALL
Java_com_wikitude_samples_plugins_SimpleInputPluginActivity_notifyNewCameraFrameN21(JNIEnv* env, jobject obj, jbyteArray cameraFrame) {
    int frameSize = -1;
